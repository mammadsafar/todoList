$(document).ready(function () {
  ...
  passwordInput = document.querySelectorAll(".user")[2]
  password_verifyInput = document.querySelectorAll(".user")[3]
  eye.addEventListener("click", function () {
    root.classList.toggle("active")
    eye.classList.toggle("fa-eye-slash")
    passwordInput.type = passwordInput.type === 'password' ? 'text' : 'password'
    password_verifyInput.type = password_verifyInput.type === 'password' ? 'text' : 'password'
    passwordInput.focus();
  })
